//
//  PerfScopeXWidget.swift
//  PerfScopeXWidget
//
//  Home screen widget for PerfScopeX
//
...
struct PerfScopeXWidgetEntryView: View {
...
struct CompactTwoMetricsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            // Header
            Label("PerfScopeX", systemImage: "chart.xyaxis.line")
                .font(.caption2.bold())
...
struct PerfScopeXWidget: Widget {
    let kind: String = "PerfScopeXWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: MetricsProvider()) { entry in
            if #available(iOS 17.0, *) {
                PerfScopeXWidgetEntryView(entry: entry)
        ...
        .configurationDisplayName("PerfScopeX")

...
- **PiPアイコン** をタップしてピクチャー・イン・ピクチャーモードに入る
...
1. ナビゲーションバーのPiPボタンをタップ
2. コンパクトなメトリクスオーバーレイが表示される
3. ドラッグして位置を変更（インタラクティブスプリングアニメーション）
4. 自動的に画面端にスナップ
5. オーバーレイの外側をタップして終了
